    ...
    <tr key={courses._id} className="">
      ...
      <td className="p-3">
        <div className="flex gap-10">
          <button className="px-2 py-1 rounded-lg text-white bg-[#EBEBEB]"
          ...
          <button className="px-2 py-1 rounded-lg text-white bg-[#EBEBEB]" onClick={()=>handleEditCourse(courses._id)}>
            <Pencil color="#171717" size={18} />
          </button>
          <button className="px-2 py-1 rounded-lg text-white bg-[#EBEBEB]" onClick={()=>handleDeleteCourse(courses._id)}>
