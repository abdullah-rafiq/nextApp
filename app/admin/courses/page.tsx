...
<div className="flex items-center gap-2 mb-10 bg-white border border-gray-400 rounded-lg px-3 py-2 w-80 hover:border-gray-600 transition-colors duration-200 focus-within:border-blue-500">
    ...
    <tr key={courses._id} className="border">
      ...
      <td className="p-3">
        <div className="flex gap-10">
          ...
          <button className="px-3 py-2 rounded-md text-white bg-[#918c8c]" onClick={()=>handleEditCourse(courses._id)}>
            <Pencil color="#dee0e3" size={18} />
          </button>
          <button className="px-3 py-2 rounded-md text-white bg-[#918c8c]" onClick={()=>handleDeleteCourse(courses._id)}>
